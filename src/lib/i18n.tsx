...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    roleAdmin: 'مدير',
    role_admin: 'مدير',
    role_regional_supervisor: 'مشرف جهوي',
    role_deputy_regional_primary: 'نائب مشرف جهوي - ابتدائي',
    role_deputy_regional_middle: 'نائب مشرف جهوي - ثانوي إعدادي',
    role_deputy_regional_high: 'نائب مشرف جهوي - ثانوي تأهيلي',
    role_provincial_manager: 'مسؤول إقليمي',
    role_deputy_provincial_primary: 'نائب مسؤول إقليمي - ابتدائي',
    role_deputy_provincial_middle: 'نائب مسؤول إقليمي - ثانوي إعدادي',
    role_deputy_provincial_high: 'نائب مسؤول إقليمي - ثانوي تأهيلي',
    role_local_coordinator: 'منسق محلي',
    role_deputy_local_primary: 'نائب منسق محلي - ابتدائي',
    role_deputy_local_middle: 'نائب منسق محلي - ثانوي إعدادي',
    role_deputy_local_high: 'نائب منسق محلي - ثانوي تأهيلي',
    role_teacher: 'أستاذ(ة)',
    role_union_officer: 'مسؤول نقابي',
    // Admin
  ...
  fr: {
    ...
    role_regional_supervisor: 'Superviseur régional',
    role_deputy_regional_primary: 'Adjoint régional - Primaire',
    role_deputy_regional_middle: 'Adjoint régional - Collège',
    role_deputy_regional_high: 'Adjoint régional - Lycée',
    role_provincial_manager: 'Responsable provincial',
    role_deputy_provincial_primary: 'Adjoint provincial - Primaire',
    role_deputy_provincial_middle: 'Adjoint provincial - Collège',
    role_deputy_provincial_high: 'Adjoint provincial - Lycée',
    role_local_coordinator: 'Coordinateur local',
    role_deputy_local_primary: 'Adjoint local - Primaire',
    role_deputy_local_middle: 'Adjoint local - Collège',
    role_deputy_local_high: 'Adjoint local - Lycée',
    role_teacher: 'Enseignant(e)',
    role_union_officer: 'Responsable syndical',
    // Admin
