...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    missionTeacher: 'أستاذ(ة)',
    missionSupportStaff: 'إطار الدعم',
    missionSupplier: 'ممون',
    missionEducationalAdvisor: 'ملحق تربوي',
    missionGuard: 'حارس عام للخارجية',
    missionDirector: 'مدير',
    missionAdministrator: 'متصرف',
    missionEducationalInspector: 'مفتش تربوي',
    missionTechAssistant: 'مساعد تقني',
    missionEconomyAdmin: 'ملحق الاقتصاد و الادارة',
    missionTreasurer: 'قيم على الخزانة',
    missionOther: 'آخر',
