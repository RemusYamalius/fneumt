    ...
    <AuthenticatedLayout>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8 flex items-start justify-between gap-4">
          <div>
            <h1 className="text-3xl font-extrabold bg-blue-100/60 text-blue-800 px-3 py-1 rounded-lg inline-block mb-1">{t.incomingRequests}</h1>
            <p className="text-sm font-semibold bg-emerald-100/60 text-emerald-700 px-2 py-0.5 rounded-md inline-block">{t.incomingRequestsDesc}</p>
          </div>
