...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    missionTeacherPrimary: 'أستاذ التعليم الابتدائي',
    missionTeacherMiddle: 'أستاذ التعليم الثانوي الإعدادي',
    missionTeacherHigh: 'أستاذ التعليم الثانوي التأهيلي',
  ...
  fr: {
    ...
    missionTeacherPrimary: 'Enseignant du primaire',
    missionTeacherMiddle: 'Enseignant du collège',
    missionTeacherHigh: 'Enseignant du lycée',
