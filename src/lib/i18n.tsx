...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    missionTeacherPrimary: 'أستاذ(ة) التعليم الإبتدائى',
    missionTeacherMiddle: 'أستاذ(ة) الثانوي الإعدادي',
    missionTeacherHigh: 'أستاذ(ة) الثانوى التأهيلى',
    missionSpecialistEducational: 'مختص(ة) تربوي (ة)',
    missionSpecialistSocial: 'مختص(ة) اجتماعى(ة)',
    missionSpecialistAdminEcon: 'مختص(ة) الإدارة والاقتصاد(ة)',
    ...
    missionAdminCrossSector: 'متصرف(ة) (الأطر المشتركة)',
    missionTeacherAggrege: 'أستاذ(ة) مبرز(ة) التربية والتكوين',
    missionCounselorGuidance: 'مستشار(ة) في التوجيه التربوي',
    missionCounselorPlanning: 'مستشار(ة) في التخطيط التربوي',
    missionInspectorPrimary: 'مفتش(ة) تربوي(ة) للتعليم الابتدائي',
    missionInspectorMiddle: 'مفتش(ة) تربوي(ة) للتعليم الثانوي الإعدادي',
    missionInspectorHigh: 'مفتش(ة) تربوي(ة) للتعليم الثانوي التأهيلي',
    missionInspectorPostBac: 'مفتش(ة) تربوي(ة) (ما بعد الباكالوريا)',
    missionInspectorGuidance: 'مفتش(ة) في التوجيه التربوي',
    missionInspectorPlanning: 'مفتش(ة) في التخطيط التربوي',
    missionInspectorFinance: 'مفتش(ة) الشؤون المالية',
    missionAdminDirector: 'متصرف(ة) تربوي(ة)',
    missionTeacherHigherEd: 'أستاذ(ة) التعليم العالي',
    missionEngineer: 'مهندس(ة)',
  ...
  fr: {
    ...
    missionSpecialistAdminEcon: "Spécialiste de l'administration et de l'économie",
    ...
    missionAdminMinistry: "Administrateur(trice) du ministère de l'Éducation nationale",
    missionAdminCrossSector: 'Administrateur(trice) (cadres communs)',
    ...
    missionInspectorPrimary: "Inspecteur(trice) pédagogique de l'enseignement primaire",
    missionInspectorMiddle: "Inspecteur(trice) pédagogique de l'enseignement secondaire collégial",
    missionInspectorHigh: "Inspecteur(trice) pédagogique de l'enseignement secondaire qualifiant",
    missionInspectorPostBac: 'Inspecteur(trice) pédagogique (post-baccalauréat)',
    missionInspectorGuidance: "Inspecteur(trice) en orientation pédagogique",
    missionInspectorPlanning: 'Inspecteur(trice) en planification pédagogique',
    missionInspectorFinance: 'Inspecteur(trice) des affaires financières',
